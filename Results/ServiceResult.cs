namespace api_backend.Results
{
    public class ServiceResult
    {
        ...
        public static ServiceResult Ok(string? message = null) => new ServiceResult()
        {
            Success = true,
            Message = message,
        };
        public static ServiceResult Fail(string message, IEnumerable<string>? errors = null) => new() { Success = false, Message = message, Errors = errors };
    }
